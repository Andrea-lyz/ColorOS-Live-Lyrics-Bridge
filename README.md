...
- a character lift animation that raises each character slightly as the word-timed highlight passes it, off by default, word-timed lyrics only, and disabled on the low frame rate always-on display;
